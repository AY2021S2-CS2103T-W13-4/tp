...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        // invalid name
        assertParseFailure(parser, VALID_NAME_ALICE + INVALID_NAME_DESC, Name.MESSAGE_CONSTRAINTS);
        // invalid phone
        assertParseFailure(parser, VALID_NAME_ALICE + INVALID_PHONE_DESC, Phone.MESSAGE_CONSTRAINTS);
        // invalid email
        assertParseFailure(parser, VALID_NAME_ALICE + INVALID_EMAIL_DESC, Email.MESSAGE_CONSTRAINTS);
        // invalid address
        assertParseFailure(parser, VALID_NAME_ALICE + INVALID_ADDRESS_DESC, Address.MESSAGE_CONSTRAINTS);
        // invalid tag
        assertParseFailure(parser, VALID_NAME_ALICE + INVALID_TAG_DESC, Tag.MESSAGE_CONSTRAINTS);

        // invalid phone followed by valid email
        assertParseFailure(parser, VALID_NAME_ALICE + INVALID_PHONE_DESC + EMAIL_DESC_AMY, Phone.MESSAGE_CONSTRAINTS);

        // valid phone followed by invalid phone. The test case for invalid phone followed by valid phone
        // is tested at {@code parse_invalidValueFollowedByValidValue_success()}
        assertParseFailure(parser, VALID_NAME_ALICE + PHONE_DESC_BOB + INVALID_PHONE_DESC, Phone.MESSAGE_CONSTRAINTS);
        ...
        assertParseFailure(parser,
                VALID_NAME_ALICE + INVALID_NAME_DESC + INVALID_EMAIL_DESC + VALID_ADDRESS_AMY + VALID_PHONE_AMY,
    ...
    public void parse_multipleRepeatedFields_acceptsLast() {
        String userInput = VALID_NAME_ALICE + PHONE_DESC_AMY + ADDRESS_DESC_AMY + EMAIL_DESC_AMY
    ...
    public void parse_invalidValueFollowedByValidValue_success() {
        ...
        userInput = VALID_NAME_ALICE + EMAIL_DESC_BOB + INVALID_PHONE_DESC + ADDRESS_DESC_BOB
                + PHONE_DESC_BOB;
